 ...
 */
static inline void
list_add(struct list_head *newn, struct list_head *head)
{
 ...
 */
static inline void
list_add_tail(struct list_head *newn, struct list_head *head)
{
 ...
 */
static inline void
list_replace(struct list_head *old, struct list_head *newn)
{
    newn->next = old->next;
    newn->next->prev = newn;
    newn->prev = old->prev;
...
static inline void
list_replace_init(struct list_head *old, struct list_head *newn)
{
